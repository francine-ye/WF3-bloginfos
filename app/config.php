...
$w_config = [
    ...
    'db_name' => 'bloginfos2',								//nom de la bdd
	...
	'security_avatar_name' => 'avatar',				//nom de la colonne pour le "avatar"
	'security_registration_date_name' => 'registration_date',	//nom de la colonne pour le "registration date"		

	'security_login_route_name' => 'login',			//nom de la route affichant le formulaire de connexion

	// configuration globale
	'site_name'	=> 'bloginfos', 								// contiendra le nom du site
];
